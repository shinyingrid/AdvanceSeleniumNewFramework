...
public class TestCreateProductAndDeleteAllProduct extends BaseClass {

	@Test
	public void TestCreateProdAndDelAllProd() throws Throwable
	{
...
//				loginPage.loginToApplication(USERNAME, PASSWORD); //FROM LoginPage POM CLASS 
				...
				//VALIDATION - IF ALL THE PRODUCTS ARE DELETED OR NOT
				prodHomePage.clickOnProductsTab();
